...
config :diff_thing,
  ecto_repos: [DiffThing.Repo],
  generators: [timestamp_type: :utc_datetime]

# Configures the endpoint
config :diff_thing, DiffThingWeb.Endpoint,
  url: [host: "localhost"],
  adapter: Bandit.PhoenixAdapter,
  render_errors: [
    formats: [html: DiffThingWeb.ErrorHTML, json: DiffThingWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: DiffThing.PubSub,
  live_view: [signing_salt: "BD4s0c6t"]
...
config :diff_thing, DiffThing.Mailer, adapter: Swoosh.Adapters.Local
...
config :inertia,
  ...
  endpoint: DiffThingWeb.Endpoint,
